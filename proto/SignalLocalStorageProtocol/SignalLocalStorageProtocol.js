...
var $root = $protobuf.roots.proto || ($protobuf.roots.proto = {});
...
$root.SignalLocalStorageProtocol = (function() {
    ...
    SignalLocalStorageProtocol.SessionStructure = (function() {
        ...
        SessionStructure.Chain = (function() {
             ...
             * @property {Array.<Protocol.IMessageKey>|null} [messageKeys] Chain messageKeys
             */
            ...
            /**
             * Chain messageKeys.
             * @member {Array.<Protocol.IMessageKey>} messageKeys
             * @memberof SignalLocalStorageProtocol.SessionStructure.Chain
             * @instance
             */
            ...
            Chain.encode = function encode(message, writer) {
                ...
                if (message.messageKeys != null && message.messageKeys.length)
                    for (var i = 0; i < message.messageKeys.length; ++i)
                        $root.Protocol.MessageKey.encode(message.messageKeys[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                return writer;
            };
                ...
                while (reader.pos < end) {
                    ...
                    case 4: {
                            if (!(message.messageKeys && message.messageKeys.length))
                                message.messageKeys = [];
                            message.messageKeys.push($root.Protocol.MessageKey.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Chain.verify = function verify(message) {
                ...
                if (message.messageKeys != null && message.hasOwnProperty("messageKeys")) {
                    ...
                    for (var i = 0; i < message.messageKeys.length; ++i) {
                        var error = $root.Protocol.MessageKey.verify(message.messageKeys[i]);
                        if (error)
            ...
            Chain.fromObject = function fromObject(object) {
                ...
                if (object.messageKeys) {
                    ...
                    for (var i = 0; i < object.messageKeys.length; ++i) {
                        ...
                        message.messageKeys[i] = $root.Protocol.MessageKey.fromObject(object.messageKeys[i]);
                    }
                }
                return message;
            };
            ...
            Chain.toObject = function toObject(message, options) {
                ...
                if (message.messageKeys && message.messageKeys.length) {
                    ...
                    for (var j = 0; j < message.messageKeys.length; ++j)
                        object.messageKeys[j] = $root.Protocol.MessageKey.toObject(message.messageKeys[j], options);
                }
                return object;
            };
