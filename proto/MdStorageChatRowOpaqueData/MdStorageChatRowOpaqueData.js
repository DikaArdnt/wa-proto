        ...
        ChatRowOpaqueData.DraftMessage = (function() {
            ...
            DraftMessage.CtwaContextData = (function() {
                ...
                CtwaContextData.decode = function decode(reader, length, error, long) {
                    ...
                    message = new $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextData();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        if (tag === error)
                            break;
            ...
            DraftMessage.CtwaContextLinkData = (function() {
                ...
                CtwaContextLinkData.decode = function decode(reader, length, error, long) {
                    ...
                    message = new $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextLinkData();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        if (tag === error)
                            break;
