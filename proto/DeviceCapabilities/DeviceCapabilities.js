    ...
    DeviceCapabilities.DeviceCapabilities = (function() {
        ...
        DeviceCapabilities.encode = function encode(message, writer, q) {
            ...
            if (message.aiFbidMigration != null && Object.hasOwnProperty.call(message, "aiFbidMigration"))
                $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration.encode(message.aiFbidMigration, writer.uint32(/* id 7, wireType 2 =*/58).fork(), q + 1).ldelim();
        ...
        DeviceCapabilities.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 7: {
                        message.aiFbidMigration = $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 8: {
                        message.bizAiSettingsSync = $root.DeviceCapabilities.DeviceCapabilities.BizAiSettingsSync.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 9: {
        ...
        DeviceCapabilities.verify = function verify(message, long) {
            ...
            if (message.aiFbidMigration != null && Object.hasOwnProperty.call(message, "aiFbidMigration")) {
                var error = $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration.verify(message.aiFbidMigration, long + 1);
                if (error)
                    return "aiFbidMigration." + error;
            }
            if (message.bizAiSettingsSync != null && Object.hasOwnProperty.call(message, "bizAiSettingsSync")) {
                var error = $root.DeviceCapabilities.DeviceCapabilities.BizAiSettingsSync.verify(message.bizAiSettingsSync, long + 1);
                if (error)
                    return "bizAiSettingsSync." + error;
            }
            if (message.contactRefresh != null && Object.hasOwnProperty.call(message, "contactRefresh")) {
                var error = $root.DeviceCapabilities.DeviceCapabilities.ContactRefresh.verify(message.contactRefresh, long + 1);
                if (error)
        ...
        DeviceCapabilities.fromObject = function fromObject(object, long) {
            ...
            if (object.aiFbidMigration != null) {
                ...
                message.aiFbidMigration = $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration.fromObject(object.aiFbidMigration, long + 1);
            }
            if (object.bizAiSettingsSync != null) {
                ...
                message.bizAiSettingsSync = $root.DeviceCapabilities.DeviceCapabilities.BizAiSettingsSync.fromObject(object.bizAiSettingsSync, long + 1);
            }
        ...
        DeviceCapabilities.toObject = function toObject(message, options, q) {
            ...
            if (message.aiFbidMigration != null && Object.hasOwnProperty.call(message, "aiFbidMigration"))
                object.aiFbidMigration = $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration.toObject(message.aiFbidMigration, options, q + 1);
            if (message.bizAiSettingsSync != null && Object.hasOwnProperty.call(message, "bizAiSettingsSync"))
        ...
        DeviceCapabilities.AiFbidMigration = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            AiFbidMigration.encode = function encode(message, writer, q) {
                if (!writer)
                    writer = $Writer.create();
                if (q === undefined)
                    q = 0;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AiFbidMigration.decode = function decode(reader, length, error, long) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                if (long === undefined)
                    long = 0;
                ...
                message = new $root.DeviceCapabilities.DeviceCapabilities.AiFbidMigration();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            AiFbidMigration.verify = function verify(message, long) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (long === undefined)
                    long = 0;
             ...
             * @returns {DeviceCapabilities.DeviceCapabilities.AiFbidMigration} AiFbidMigration
             */
            AiFbidMigration.fromObject = function fromObject(object, long) {
             ...
             * @returns {Object.<string,*>} Plain object
             */
            AiFbidMigration.toObject = function toObject(message, options, q) {
                if (!options)
                    options = {};
                if (q === undefined)
                    q = 0;
        ...
        DeviceCapabilities.BizAiSettingsSync = (function() {
             ...
             * @member {boolean} handoffRemovalTimingEnabled
             ...
             * @returns {$protobuf.Writer} Writer
             */
            BizAiSettingsSync.encode = function encode(message, writer, q) {
                if (!writer)
                    writer = $Writer.create();
                if (q === undefined)
                    q = 0;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            BizAiSettingsSync.decode = function decode(reader, length, error, long) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                if (long === undefined)
                    long = 0;
                ...
                message = new $root.DeviceCapabilities.DeviceCapabilities.BizAiSettingsSync();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            BizAiSettingsSync.verify = function verify(message, long) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (long === undefined)
                    long = 0;
             ...
             * @returns {DeviceCapabilities.DeviceCapabilities.BizAiSettingsSync} BizAiSettingsSync
             */
            BizAiSettingsSync.fromObject = function fromObject(object, long) {
             ...
             * @returns {Object.<string,*>} Plain object
             */
            BizAiSettingsSync.toObject = function toObject(message, options, q) {
                if (!options)
                    options = {};
                if (q === undefined)
                    q = 0;
                ...
                var object = {};
                if (options.defaults)
                    object.handoffRemovalTimingEnabled = false;
                if (message.handoffRemovalTimingEnabled != null && Object.hasOwnProperty.call(message, "handoffRemovalTimingEnabled"))
        ...
        DeviceCapabilities.BusinessBroadcast = (function() {
             ...
             * @member {boolean} proCompanionSupportEnabled
             * @memberof DeviceCapabilities.DeviceCapabilities.BusinessBroadcast
             * @instance
             */
            ...
            BusinessBroadcast.toObject = function toObject(message, options, q) {
                ...
                if (options.defaults) {
                    ...
                    object.proCompanionSupportEnabled = false;
                }
                if (message.importListEnabled != null && Object.hasOwnProperty.call(message, "importListEnabled"))
        ...
        DeviceCapabilities.ContactRefresh = (function() {
             ...
             * @member {boolean} refreshSupported
            ...
            ContactRefresh.decode = function decode(reader, length, error, long) {
                ...
                message = new $root.DeviceCapabilities.DeviceCapabilities.ContactRefresh();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
